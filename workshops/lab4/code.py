...
class CodeDeployer:
    ...
    def deploy(self, hecate, wire):
        # TODO: Inject the most recently harvested credential onto the wire.
        # Watch the serial monitor to see the payload (tagged with a *) fire.
        pass
...
# TODO: Create a CodeDeployer and register a timer trigger on the
# "from_keypad" wire that fires every 3 seconds.
